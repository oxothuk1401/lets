                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12 col-md-12">
                                                                <p class="teacherName text-left">Лиза<img
                                                                        src="/resources/images/icons/hurt.png"></p>
                                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body modalBodyStyle">
                        <form method="POST" action="/registration" class="form-signin">
                            <div class="form-group">
                                <input class="form-control" type="text" name="regUsername" id="regUsername" value=""
                                       placeholder="regUsername" required>
                                <input class="form-control" type="email" name="regEmail" id="regEmail" value=""
                                       placeholder="regEmail" required>
                                <input class="form-control" type="password" name="regPassword" id="userPsw" value=""
                                       placeholder="regPassword" required>
                                <c:if test="${not empty error}">
                                    <p>${error}</p>
                                </c:if>
                                <input class="form-control" type="password" name="regConfirmPassword"
                                       id="confirmUserPsw" value="" placeholder="regConfirmPassword" required>
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
